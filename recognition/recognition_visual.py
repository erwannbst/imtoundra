...
# Obtenir le nombre de cycles CPU avant l'exécution de la détection
...
if len(indices) > 0:
    for i in indices.flatten():
        ...
        cv2.putText(image, text, (x + 2, y + 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, color, 2)

# Obtenir le nombre de cycles CPU après l'exécution de la détection
...
print("Temps écoulé:", time_elapsed, "secondes")
